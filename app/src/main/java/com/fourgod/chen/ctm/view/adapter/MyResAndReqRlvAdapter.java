...
public class MyResAndReqRlvAdapter extends BaseQuickAdapter<InfoAllListBean.DataBean,BaseViewHolder> {
    ...
    public MyResAndReqRlvAdapter(int layoutResId, @Nullable List<InfoAllListBean.DataBean> data, Context context) {
        super(layoutResId, data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, InfoAllListBean.DataBean item) {
